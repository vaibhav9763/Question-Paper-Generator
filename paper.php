...
if ($totalmarks==25) {
  ...
  <h3 style="margin-left: 85% ;position: absolute;"> Marks</h3><br><h3 style=" position: absolute;"> 2. Attempt any TWO of the following :</h3><h4 style="margin-left: 85% ;position: absolute;"> 2 X 4 = 8</h4><br><br>
  
  <?php 
   $sql ="SELECT *  FROM `question` WHERE `marks` = 4 AND `difficultyofquestion` LIKE '%$difficultyofquestion%'   AND `subject` LIKE '$s_name' AND `semester` = $semester AND  `branch` LIKE '$branch' AND `chapter` IN ('$chapter1',  '$chapter2',  '$chapter3',  '$chapter4',  '$chapter5',  '$chapter6',  '$chapter7',  '$chapter8',  '$chapter9',  '$chapter10')  ORDER BY RAND() LIMIT 3 "; 
...
<h3 style="margin-left: 85% ;position: absolute;"> Marks</h3><br><h3 style=" position: absolute;"> 3. Attempt any TWO of the following :</h3><h4 style="margin-left: 85% ;position: absolute;"> 2 X 4 = 8</h4><br><br>
